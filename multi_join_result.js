...
multi_join_result.create = function (table1, table2){
    con.getConnection(function(err,conn){
        ...
        for(let i=0; i<table2.length; i++){
          ...
          var sql2 = "insert into multi_join_result(테이블A, 테이블A_레코드_수, 테이블B, 테이블B_레코드_수) select a.table_name, a.TABLE_ROWS, b.table_name, b.TABLE_ROWS from INFORMATION_SCHEMA.tables a, INFORMATION_SCHEMA.tables b where a.table_name='"+table1+"' and b.table_name='"+table2[i]+"'";
