...
select_table.create = function (){
    con.getConnection(function(err,conn){
        ...
        var sql = "insert into selecttable(테이블_명, 레코드_수) select table_name, TABLE_ROWS from INFORMATION_SCHEMA.tables where table_schema='testdb' and not table_name in ('selecttable','statistic_attribute','category_attribute')";
        conn.query(sql, function (err, result) {
          if (err) throw err;
          console.log("Table created");
        });
